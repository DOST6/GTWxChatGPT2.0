...
<body class="bgimg">
    ...
    <div class="w3-container w3-top-left w3-xlarge w3-padding">
    ...
    <div class="w3-container" id="main">
        ...
        <div class="w3-container w3-row" style="margin-top:0px">
            ...
            <div class="w3-col l8 w3-padding">
                <!-- Stats -->
                <div class="w3-padding" style="display: <?= $started ? "block" : "none" ?>">
        ...
        <div class="w3-row-padding" style="display: <?= $started?"none":"block" ?>">
            ...
            <div class="w3-col m6 w3-container w3-card-4 w3-round-large w3-padding bg-opacity ">
                ...
                <form method="post" action="<?= base_url() ?>" class="w3-row-padding">
                    <div class="w3-col m8">
                        <input class="w3-input w3-border" type="text" name="name" id="playerName" placeholder="Your Name" value="" <?= $started ? "readonly" : "" ?> required />
                    </div>
                    <div class="w3-col m4">
        ...
        <div class="w3-container" id="game" style="display: <?= $started?"block":"none" ?>">
            ...
            <!-- Round -->
            <div class="w3-row" style="display: none" id="play_round">
                <div class="w3-col l1 w3-padding"></div>
                <div class="w3-col l10 w3-padding">
                    <!-- Category and Clue -->
                    <div class="w3-row-padding w3-center" id="cat_clue">
                        <div class="w3-col m3">
                            <span class="w3-tag w3-padding w3-round-large w3-blue w3-xlarge" id="category"></span>
                            <h4 class="w3-text-blue">Category</h4>
                        </div>
                        <div class="w3-col m9">
                            <span class="w3-tag w3-padding w3-round-large w3-blue w3-xlarge" id="clue"> </span>
                    ...
                    <div class="w3-row-padding w3-center">
                        <div class="w3-col m3 w3-panel">
                            <button class="w3-button w3-block w3-blue w3-round-large w3-large" id="reset" <?= $started ? "disabled" : "disabled" ?>>Next Round <i class='fas fa-fast-forward'></i></button>
                        </div>
                        <div class="w3-col m3 w3-panel">
                            <button class="w3-button w3-block w3-orange w3-round-large w3-large" id="guessWord" onclick="$('#guess_modal').show()"<?= $started ? "disabled" : "disabled" ?>>Guess Word <i class='far fa-comment-dots'></i></button>
                        </div>
                        <div class="w3-col m3 w3-panel">
                            <button class="w3-button w3-block w3-green w3-round-large w3-large w3-hover-blue" id="getClue" <?= $started ? "disabled" : "disabled" ?>>Get Clue <i class='far fa-lightbulb'></i></button>
                        </div>
                        <div class="w3-col m3 w3-panel">
                            <button class="w3-button w3-block w3-red  w3-round-large w3-large" id="endGame" <?= $started ? "" : "disabled" ?>>End Game <i class='fas fa-power-off'></i></button>
                        </div>
                    </div>
